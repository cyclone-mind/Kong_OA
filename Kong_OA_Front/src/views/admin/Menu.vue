<template>
  ...
  <div class="data-area">
    ...
    >
      ...
      <el-table-column prop="permission" label="权限编码" sortable width="180">
      </el-table-column>
      ...
      <el-table-column prop="menu_sort" label="排序号"> </el-table-column>
      <el-table-column prop="hidden" label="状态">
        <template #default="scope">
          <el-tag size="small" v-if="!scope.row.hidden" type="success"
            >正常</el-tag
          >
  ...
  >
    ...
    >
      ...
      <el-form-item label="排序号" prop="menu_sort" label-width="100px">
        <el-input-number v-model="editForm.menu_sort" :min="1" label="排序号"
          >1</el-input-number
        >
      </el-form-item>
...
const editFormRules = ref({
  ...
  menu_sort: [{ required: true, message: "请填入排序号", trigger: "blur" }],
});
// 新增菜单下拉选择用
