    ...
    <div class="container">
        <form class="form" @submit.prevent="Login">
            ...
            <div class="inputForm">
                ...
                <input type="text" v-model= "loginForm.username" class="input" placeholder="请输入你的用户名">
            </div>
            ...
            <div class="inputForm">
                ...
                <input type="password" v-model= "loginForm.password" class="input" placeholder="请输入你的密码">
            ...
            <div class="flex-row">
                <div>
                    <input type="checkbox">
                    <label class="label mx-2"> 记住我 </label>
                </div>
...
async function Login(){
  ...
  if(loginForm.password&&loginForm.username){
    ...
    $user.set_user({username:res.data.username,avatar:res.data.avatar,token:res.data.token})
